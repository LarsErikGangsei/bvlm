...
## -------------------------------------------------------------------- ##
#  Function returning the probability density value (pdf-value) for 
#  Bivariate linear regression at parameter value theta
...
## Arguments ---------------------------------------------------------- ##
#  theta:   A vector of length 2p + 3 containing values for lambda11,
#           lambda22,Beta1,Beta2 and lambda12
#  XtX1:    Gram matrix (p x p) based on X1.
#  XtX2:    Gram matrix (p x p) based on X2.
#  Betah1:  (p x 1) ols estimate for Beta1
#  Betah2:  (px 2) ols estimate for Beta1 and Beta2 based on n2
#  QQ:      2 x 2 squared residual matrix
#  qq3:     SSE for linear model based on XX1
#  nn1:     Number of observations (X1).
#  nn2:     Number of observations (X2).
#  log_r:   Logical. When TRUE (default) log likelihood is returned.

## Value -------------------------------------------------------------- ##
#  The likelihood for model in question avaluated at theta.
